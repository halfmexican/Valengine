...
namespace Valengine {
    ...
    public class Window : GLib.Object {
        ...
        public bool hidden {
            get {
                return (Raylib.is_window_hidden ());
            }
            set {
                if (value == true)
        ...
        public bool minimized {
            get {
                return (Raylib.is_window_minimized ());
            }
            set {
                if (value == true)
        ...
        public bool maximized {
            get {
                return (Raylib.is_window_maximized ());
            }
            set {
                if (value == true)
        ...
        public bool focused {
            get {
                return (Raylib.is_window_focused ());
            }
        }
        /**
        ...
        public bool resized {
            get {
                return (Raylib.is_window_resized ());
            }
        }
        /**
